...
class QuikPy:
    ...
    def callback_handler(self):
        ...
        fragments = []  # Будем получать ответ в виде списка фрагментов. Они могут быть разной длины. Ответ может
        ...
        while getattr(thread, 'process', True):  # Пока поток нужен
            while True:  # Пока есть что-то в буфере ответов
                ...
                fragments.append(fragment.decode('cp1251'))  # Переводим фрагмент в Windows кодировку 1251, добавляем
                # в список
